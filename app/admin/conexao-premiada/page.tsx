...
const getSaleAmount = (sale: { saleValue?: number | null; amount?: number | null }) =>
  sale.saleValue ?? sale.amount ?? 0

const getProfessionalEmail = (sale: {
  professional?: { email?: string | null } | null
  redeemedProfessional?: { email?: string | null } | null
  professionalEmail?: string | null
}) =>
  sale.professional?.email ?? sale.redeemedProfessional?.email ?? sale.professionalEmail ?? "-"
...
export default function PhysicalSalesPage() {
  ...
  const getSafeSaleAmount = (sale: { saleValue?: number | null; amount?: number | null }) => {
